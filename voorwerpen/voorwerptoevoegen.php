                ...
                <div class="columns">
                    <div class="column">
                        <div class="field">
                            ...
                            <div class="control">
                                <input name="titel" id="titel" class="input" type="text" maxlength="254" required>
                            </div>
                        </div>
                    ...
                    <div class="column">
                        <div class="field">
                            ...
                            <div class="control">
                                <input name="startprijs" id="startprijs" class="input" step="0.01" min="0" max="9999999999" type="number" required>
                            </div>
                        </div>
